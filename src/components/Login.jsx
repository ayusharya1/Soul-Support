        ...
        <div className="left">
          <form className="loginform " onSubmit={handleSubmit}>
            ...
            <div className="dwn">
              ...
              <input className="text-black" type="email" id="mail" placeholder="Enter Your Maid Id" name="email" onChange={handleInput}/>
              ...
              <div className="forget text-white">Forget Password?</div>
            </div>
              <div className="dwn1">
