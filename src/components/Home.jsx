...
import saurabh from "../assests/saurabh.jpg";
import nishant from "../assests/nishant.jpg";
import kanak from "../assests/kanak.jpg";
      ...
      <section className="bg-backg pb-28" id="team"> 
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
          <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white capitalize">Our team</h2>
          ...
          <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <div className="text-center text-gray-500 dark:text-gray-400">
              <img className="mx-auto mb-4 w-36 h-36 rounded-full object-cover" src={ayush} alt="Bonnie Avatar" />
              <h3 className="mb-1 text-2xl font-extrabold tracking-tight text-gray-900 dark:text-white">
                <a href="#">Ayush Arya</a>
              </h3>
            ...
            <div className="text-center text-gray-500 dark:text-gray-400">
              <img className="mx-auto mb-4 w-36 h-36 rounded-full" src={nishant} alt="Helene Avatar" />
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                <a href="#">Nishant Nayan</a>
              </h3>
            ...
            <div className="text-center text-gray-500 dark:text-gray-400">
              <img className="mx-auto mb-4 w-36 h-36 rounded-full" src={kanak} alt="Jese Avatar" />
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                <a href="#">Kanak Bansal</a>
              </h3>
              <p>Frontend Developer</p>
              <ul className="flex justify-center mt-4 space-x-4">
                <li>
            ...
            <div className="text-center text-gray-500 dark:text-gray-400">
              <img className="mx-auto mb-4 w-36 h-36 rounded-full object-cover" src={saurabh} />
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
